...
@pytest.mark.asyncio
async def test_requesty_provider_restores_selected_model_author_prefix():
    from dojoagents.agent.providers import OpenAICompatibleProvider
    ...
    assert client_cls.return_value.chat.completions.create.await_args.kwargs["model"] == "openai/gpt-4o-mini"
