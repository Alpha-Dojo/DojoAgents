import type { CoreSectorLabelPath, CoreSectorOption } from '../types/dojoCore';
import type { SectorPathSelection } from '../types/sectorTaxonomy';

export function selectionFromSectorOption(option: CoreSectorOption): SectorPathSelection {
  return {
...
export function formatSectorOptionL3(
  option: CoreSectorOption,
  text: (value: CoreSectorLabelPath['level3']) => string,
): string {
