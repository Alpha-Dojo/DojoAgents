import type { CoreIncomeDistributionItem, CoreIncomeMainopType } from '../types/dojoCore';
...
export function prepareIncomeListRows(items: CoreIncomeDistributionItem[]): IncomeChartSlice[] {
  const sorted = [...items]
