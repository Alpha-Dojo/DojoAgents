import type { EntityKlineBar, EntityKlineInterval, EntityQuoteSnapshot } from '../types/entity';
import type { CoreTickerKlineBar } from '../api/entity';
...
export const KLINE_INTERVAL_API: Record<EntityKlineInterval, string> = {
  '5m': '5m',
  '1D': '1D',
  '1W': '1W',
  '1M': '1M',
...
export const KLINE_INTERVAL_LIMIT: Record<EntityKlineInterval, number> = {
  '5m': 120,
  '1D': 270,
  '1W': 120,
  '1M': 60,
...
export const KLINE_DISPLAY_LIMIT: Record<EntityKlineInterval, number> = {
  '5m': 96,
  '1D': 0,
  '1W': 80,
  '1M': 48,
...
export function mapKlineBarToCore(bar: CoreTickerKlineBar): EntityKlineBar {
  return {
...
export function resolveLatestKlineAnchorDate(bars: EntityKlineBar[]): string | null {
...
export function sliceCoreKlineToYearWindow(bars: EntityKlineBar[]): EntityKlineBar[] {
