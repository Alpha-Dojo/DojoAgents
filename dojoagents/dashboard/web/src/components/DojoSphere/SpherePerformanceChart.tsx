...
import { fetchBenchmarkCatalog } from '../../api/dojoMesh';
import { useTranslation } from '../../hooks/useTranslation';
import type { BenchmarkCard } from '../../types/dojoMesh';
...
export function SpherePerformanceChart({
  path,
  scope,
  points,
  windowStart,
        ...
        <div className="sphere-performance__controls">
          ...
          <div className="sphere-performance__markets" ref={marketsRef}>
            <button
              ...
              aria-label={t('sphere.marketsLabel')}
            ...
            {marketsOpen && (
              <ul className="sphere-performance__markets-menu" role="listbox" aria-label={t('sphere.marketsLabel')}>
