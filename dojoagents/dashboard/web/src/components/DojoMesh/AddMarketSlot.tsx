  ...
  return (
    <>
      <button
        ...
        aria-label={t('mesh.addMarketAria')}
        title={t('mesh.addMarket')}
      ...
      {open && (
        <div className="mesh-add-market-dialog" role="presentation">
          <button
            ...
            aria-label={t('mesh.comingSoonDismiss')}
          ...
          >
            <h3 id="mesh-add-market-title" className="mesh-add-market-dialog__title">
              {t('mesh.comingSoonTitle')}
            </h3>
            <p className="mesh-add-market-dialog__body">{t('mesh.comingSoonBody')}</p>
            <button
              type="button"
              className="mesh-add-market-dialog__action"
              onClick={() => setOpen(false)}
            >
              {t('mesh.comingSoonDismiss')}
            </button>
          </div>
        </div>
      )}
