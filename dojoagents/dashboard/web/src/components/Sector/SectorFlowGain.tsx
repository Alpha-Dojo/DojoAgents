...
import type { SphereFlowGauge } from '../../mocks/sectorMock';

interface SectorFlowGainProps {
...
export function SectorFlowGain({ gauges }: SectorFlowGainProps) {
  const { t } = useTranslation();

  return (
    <article className="sphere-card sphere-flow-gain">
      <h3 className="sphere-card__title sphere-card__title--compact">{t('sectorPage.flowGain')}</h3>
