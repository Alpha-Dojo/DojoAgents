...
import { SectorLevelPerformanceSparkline } from './SectorLevelPerformanceSparkline';
import { SectorLevelRiskMetrics } from './SectorLevelRiskMetrics';
import { SectorLevelSectorSelect } from './SectorLevelSectorSelect';
          ...
          return (
            ...
            >
              <header className="sphere-level-card__head">
                <h3 className="sphere-level-card__title">
                  ...
                  <span className="sphere-level-card__meta">
                    <span className="sphere-level-card__counts" aria-label={t('sectorPage.memberCounts')}>
                    ...
                    {isSelected && (
                      <span className="sphere-level-card__badge">{t('sectorPage.currentLevel')}</span>
                    )}
                  </span>
                </h3>
              </header>
              ...
              <div className="sphere-level-card__charts">
                <VerticalColumnPanel
                  title={t('sectorPage.marketCapColumn')}
                  columns={card.capPanel.columns}
                  loading={metricsLoading}
                  hasMetrics={metrics != null}
                />
                <VerticalColumnPanel
                  title={t('sectorPage.weightedPeTtm')}
              ...
              >
                <section className="sphere-level-card__module sphere-level-card__module--performance">
                  <SectorLevelPerformanceSparkline
