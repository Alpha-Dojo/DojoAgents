...
export function SectorLevelFilter({
  ...
  return (
    <div className="sphere-level-filter" role="group" aria-label={t('sectorPage.filterLabel')}>
      <div className="sphere-level-filter__field">
        <span className="sphere-level-filter__label">{t('sectorPage.level1')}</span>
        <DojoDropdownSelect
          aria-label={t('sectorPage.level1')}
      ...
      <div className="sphere-level-filter__field">
        <span className="sphere-level-filter__label">{t('sectorPage.level2')}</span>
        <DojoDropdownSelect
          aria-label={t('sectorPage.level2')}
          className="sphere-level-filter__select"
          value={level2Id}
          onChange={(nextL2) => {
      ...
      <div className="sphere-level-filter__field">
        <span className="sphere-level-filter__label">{t('sectorPage.level3')}</span>
        <DojoDropdownSelect
          aria-label={t('sectorPage.level3')}
          className="sphere-level-filter__select"
          value={level3Id}
