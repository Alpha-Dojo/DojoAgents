...
from dojoagents.harnesses.built_in.financial.services.benchmark_store import DEFAULT_BENCHMARKS
from dojoagents.harnesses.built_in.financial.services.market_sector_lead import concept_code_for, link_key_from_concept_code, slugify
...
def compute_and_stage_theme_state(
    *,
    ...
    validate_theme_state_frames(theme_df, benchmark_df, fundamentals_df, horizon_df, radar_df, advice_df)
...
async def build_theme_state_precomputed(
    ...
    *,
    ...
    """Read Phase A files, publish a unified sector bundle, and optionally upload it."""
