...
from dojoagents.harnesses.built_in.financial.services.stock_quote_filter import configure_ticker_market_cap_mins
...
def _builtin_task_roots() -> tuple[Path, Path]:
    financial_root = Path(__file__).resolve().parent.parent
    return (
        financial_root / "tasks" / "definitions",
        financial_root / "pipelines" / "definitions",
    )
