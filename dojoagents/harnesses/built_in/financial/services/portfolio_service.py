...
from dojoagents.harnesses.built_in.financial.services.portfolio_allocation import (
    resolve_cost_date,
)
...
from dojoagents.harnesses.built_in.financial.services.portfolio_store import MARKETS, PortfolioStore
...
from dojoagents.harnesses.built_in.financial.services.market_stats import display_valuation_ratio
...
from dojoagents.harnesses.built_in.financial.services.benchmark_store import DEFAULT_LOOKBACK_DAYS
...
from dojoagents.harnesses.built_in.financial.services.portfolio_candidate_index import (
...
def _portfolio_start_date(config: Optional[dict], orders: list[dict]) -> str:
    ...
    from dojoagents.harnesses.built_in.financial.services.portfolio_order_execution import market_filled_orders
    ...
    if dates:
        return min(dates)
    from dojoagents.harnesses.built_in.financial.services.portfolio_store import DEFAULT_PORTFOLIO_START_DATE
